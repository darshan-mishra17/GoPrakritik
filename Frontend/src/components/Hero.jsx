...
export default function Hero() {
  return (
    <div className="flex items-center md:mx-24 md:my-8 p-5">
      <div className="max-w-2xl">
        <h1 className="text-white text-4xl sm:text-3xl md:text-6xl lg:text-6xl font-bold mb-6 leading-[1.3]">
          Bringing Nature’s
          <br />
          Best to Your
          <br />
        ...
        <Link 
          to="/login" 
          className="group relative overflow-hidden bg-transparent text-lg md:text-xl text-white px-6 md:px-8 py-2 md:py-3 rounded-full font-semibold transition duration-500 inline-block"
        >
